...
@section('site')
    ...
    {{-- ! Banners ! --}}
    @include('frontend.pages.home.banners')
    {{-- ! New Products ! --}}
    @include('frontend.pages.home.new_products')
    {{-- ! Featured Products ! --}}
    @include('frontend.pages.home.featured_products')
    {{-- ! TV Category ! --}}
    @include('frontend.pages.home.tv_categories')
    {{-- ! T-Shirts Category ! --}}
    @include('frontend.pages.home.shirts_category')
    {{-- ! Computer Category ! --}}
    @include('frontend.pages.home.computer_category')
    {{-- ! Deals ! --}}
    @include('frontend.pages.home.deals')
    {{-- ! Vendors List ! --}}
    @include('frontend.pages.home.vendor_list')
@endsection